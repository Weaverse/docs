...
# Weaverse Core Concepts

Understanding these fundamental concepts will help you build more effective Weaverse themes and make the most of the platform's capabilities.
...
### [How Weaverse Works](core-concepts/how-it-works)
...
- **For Developers**: Continue to [Development Guide](development-guide)
- **For Integration**: See [v5 Migration Guide](migration-advanced/v5-migration)
- **For Advanced Usage**: Explore [API Reference](api-reference)