...
| API | Type | Purpose |
|-----|------|---------|
| [Content API](/content-api/overview) | REST (read + write) | Pages, theme settings, translations, languages, project metadata |
...
The Content API is a REST API for reading and updating Weaverse-managed content:
