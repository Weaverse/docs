...
This is expected behavior. Shopify's analytics bus respects consent settings. See [Cookie consent and analytics](#cookie-consent-and-analytics) for handling this in your pixel code.
...
- [Shopify Pixels overview](https://shopify.dev/docs/apps/build/marketing-analytics/pixels)
- [Shopify Web Pixels API](https://shopify.dev/docs/api/web-pixels-api)
- [GA4 DebugView Setup](https://support.google.com/analytics/answer/7201382?hl=en)
