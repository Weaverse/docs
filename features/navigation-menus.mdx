...
![Menu items editor with labels and Shopify resource links](/images/navigation-menus/menu-items-editor.png)
...
![Dropdown menu with nested collection links](/images/navigation-menus/dropdown-menu-editor.png)
