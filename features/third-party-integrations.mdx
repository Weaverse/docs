...
The Judge.me integration leverages Hydrogen's existing product route data by accessing it through the React Router loader:
...
function ReviewIndex({ ref, ...props }: ReviewIndexProps) {
