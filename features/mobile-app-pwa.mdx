...
<video controls playsInline muted preload="metadata" poster="/images/pwa/mobile-app-pwa-demo-poster.png" style={{ width: "100%", borderRadius: "8px" }}>
  <source src="/videos/pwa/mobile-app-pwa-demo-hq.m4v" type="video/mp4" />
</video>
