...
![Save as global section option in the section menu](/images/global-sections/save-as-global-section-menu.png)
...
_Note: You can add multiple different global sections to the same page. Each specific global section can be added only once per page._
