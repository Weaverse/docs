...
_Additional Note_: For Shopify Starter or Development plans, use [Vercel](deployment/vercel) or another platform, as the Hydrogen app cannot deploy to Oxygen.
