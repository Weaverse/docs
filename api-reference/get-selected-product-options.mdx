...
- [Shopify Hydrogen's getSelectedProductOptions](https://shopify.dev/docs/api-reference/hydrogen/2025-01/utilities/getselectedproductoptions) - Original implementation that this function extends
- [Shopify's Storefront API Product Variants](https://shopify.dev/docs/api-reference/storefront/latest/objects/productvariant)
