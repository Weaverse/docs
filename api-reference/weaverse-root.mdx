...
- [useWeaverse](api/use-weaverse) - Hook to access the Weaverse instance
- [WeaverseHydrogenRoot](api/weaverse-hydrogen-root) - Hydrogen-specific wrapper around WeaverseRoot
- [useItemInstance](api/use-item-instance) - Access component instances in the tree
