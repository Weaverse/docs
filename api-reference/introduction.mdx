...
<CardGroup cols={2}>
  <Card title="Components" icon="cube" href="/docs/api-reference/weaverse-root">
    Core rendering components for Weaverse content
  </Card>
  <Card title="Hooks" icon="hook" href="/docs/api-reference/use-weaverse">
    React hooks for accessing Weaverse functionality
  </Card>
  <Card title="Types" icon="code" href="/docs/api-reference/types">
    TypeScript interfaces and type definitions
  </Card>
  <Card title="Utilities" icon="wrench" href="/docs/api-reference/get-selected-product-options">
...
- **[Development Guide](/docs/development-guide)** - Step-by-step development tutorials
