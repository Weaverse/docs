...
- [withWeaverse](api/with-weaverse) - HOC that sets up the theme settings provider
- [Global Theme Settings](guides/global-theme-settings) - Guide to configuring global theme settings
- [WeaverseHydrogenRoot](api/weaverse-hydrogen-root) - Main component that initializes Weaverse
