...
- [useItemInstance](api/use-item-instance) - Access a specific component instance
- [useParentInstance](api/use-parent-instance) - Access the parent component instance
- [useChildInstances](api/use-child-instances) - Access child component instances
- [useThemeSettings](api/use-theme-settings) - Access theme settings
