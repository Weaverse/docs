...
<CardGroup cols={3}>
  <Card title="1. Create the project" icon="terminal" href="/intro/quickstart#set-up-with-your-ai-agent-recommended">
    Use the AI-agent prompt from onboarding or run the Weaverse CLI command.
  </Card>
  <Card title="2. Preview locally" icon="monitor" href="/intro/quickstart#create-project--load-studio">
    Start the Hydrogen dev server and load the storefront at `localhost:3456`.
  </Card>
  <Card title="3. Connect real data" icon="database" href="/intro/quickstart#connect-your-real-store-data">
