...
Weaverse v5 introduces a major architectural change, migrating from Remix to React Router v7 to align with Shopify Hydrogen's framework migration. See the current [Hydrogen updates](https://hydrogen.shopify.dev/updates).
...
**🔮 Future-Ready**
- Aligned with Shopify Hydrogen's React Router architecture
...
2. **Node.js 22.12 or newer** installed for the current Pilot project
