...
Ready to upgrade? Follow the steps above or [create a new project](hydrogen/getting-started) to experience the power of Weaverse v5!
...
2. Review the [API Types documentation](api/types) for updated type definitions
