...
<Note>
  **Weaverse v5 runs on React Router v7**, aligning with [Shopify Hydrogen's May 2025 release](https://hydrogen.shopify.dev/update/may-2025). Pick the version that matches your Hydrogen setup:
...
If you're currently on Hydrogen with Remix and want to move to React Router v7, follow the [official Shopify migration guide](https://hydrogen.shopify.dev/update/may-2025) first, then install Weaverse v5. See also the [Weaverse v5 migration guide](/migration-advanced/v5-migration). Alternatively, stay on Weaverse v4 with your current Remix setup.
