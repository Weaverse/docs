...
- [Resource Picker Inputs](#resource-picker-inputs)
...
Now that you have a solid understanding of Input Settings, you can:

- Learn about [Data Fetching](/development-guide/data-fetching) to work with Shopify data
- Explore [Component Schemas](/development-guide/component-schema) for advanced configuration
- Check out [Styling & Theming](/development-guide/styling-theming) for design customization