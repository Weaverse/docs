...
- Node.js 22.12 or newer installed (required by the current Pilot template)
...
- Explore [Features](/features/global-sections)
- Learn about [Pilot Theme](/hydrogen-themes/pilot-theme-overview)
- Study the [API Reference](/api-reference/introduction)
- Join the [Developer Community](/community/community)