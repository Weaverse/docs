...
Data connectors allow you to dynamically insert data from your Weaverse application into text content using a simple template syntax. This powerful feature enables rich, dynamic content that automatically updates when your data changes.
...
- [Data Fetching](development-guide/data-fetching) - Load component data
- [Creating Components](development-guide/creating-components) - Build custom components