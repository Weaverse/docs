...
# Building Weaverse Hydrogen Components

Weaverse Components are the building blocks of your Hydrogen theme. They combine React's component model with Weaverse's powerful schema system to create customizable, performant sections for your storefront. This comprehensive guide covers how to create, configure, and optimize Weaverse components for maximum flexibility and performance.
...
3. **Component**: Create the component using modern React function component syntax
...
5. **Export**: Export the component as default
 ...
 > **Note about `forwardRef`**: `forwardRef` is **no longer required** in modern Weaverse components. With React 19 and current Weaverse architecture, you can simply spread props to your root DOM element (e.g., `<div {...props}>`) and Weaverse will automatically handle ref management and editor integration. This makes component code simpler and more straightforward.
...
// Modern approach - no forwardRef needed
...
2. **Props spreading**: Always spread remaining props to root DOM element to enable Weaverse editor integration
...
- **Follow React's Best Practices**
  - Always spread props to root elements: `<div {...props}>`
...
- Learn about [Component Schema](development-guide/component-schema) for advanced schema configuration
- Explore [Data Fetching](development-guide/data-fetching) for more data integration patterns
- See [Example Components](guides/example-components) for inspiration and reference implementations
- Join our [Community](community) for support and sharing best practices
