...
2.  Choose **Metafields and Metaobjects**, then click **Add definition**.

    ![Metafields and metaobjects option in Shopify settings](/images/pilot-theme/metafields-and-metaobjects-settings.png)
