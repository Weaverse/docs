...
- **[Overview](/hydrogen-themes/pilot-theme-overview)** - Theme features and structure
- **[Sections](/hydrogen-themes/pilot-theme-sections)** - Available page sections  
- **[Customization](/hydrogen-themes/pilot-theme-customization)** - Fonts, colors, and styling
...
Ready to start building? Check out our [Getting Started guide](/getting-started/installation) to set up your development environment!