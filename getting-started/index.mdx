...
- [📚 5-Minute Quickstart](getting-started/quickstart) - Get a demo site running locally
...
├── app/weaverse/           # Theme configuration
└── package.json
```
...
1. **Start Here**: Follow our [Quickstart Guide](getting-started/quickstart)
2. **Understand**: Read [Core Concepts](core-concepts) to learn how Weaverse works
3. **Build**: Follow the [Development Guide](development-guide) to create components
4. **Deploy**: Use our [Deployment Guide](deployment) to go live

## Need Help?

- 💬 [Community Forum](community) - Connect with other developers
