...
<CardGroup cols={2}>
  <Card title="Deploy to Oxygen" icon="rocket" href="/guides/deployment/oxygen">
    Shopify's edge hosting platform (recommended)
  </Card>
  <Card title="Deploy with Docker" icon="docker" href="/guides/deployment/docker">
    Self-hosted containerized deployment
  </Card>
  <Card title="Other Platforms" icon="cloud" href="/guides/deployment">
