...
With Weaverse, a reviews integration such as Judge.me can render compact ratings or initial reviews server-side, then defer heavier review lists and pagination behind a Hydrogen resource route. Credentials stay on the server, while the storefront controls when and how much review data it loads.

<Tip>
  See the [Judge.me Reviews for Hydrogen](/hydrogen-integrations/judgeme-reviews) walkthrough and the general [Third-Party Integration](/features/third-party-integrations) guide.
</Tip>
...
Weaverse provides a [Content API](/content-api/overview) — a REST API that lets you read and update your page content, theme settings, and project data from **any application**.
...
<CardGroup cols={2}>
  <Card title="5-Minute Quickstart" icon="rocket" href="/intro/quickstart">
