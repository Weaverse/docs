...
<Card title="Component Development" icon="wrench" href="/development-guide/creating-components">
  Learn to build powerful Weaverse components with schemas and settings.
</Card>

<Card title="Input Settings" icon="pen-to-square" href="/development-guide/input-settings">
  Master component customization options for merchants.
</Card>

<Card title="Studio Interface" icon="palette" href="/studio-guide/interface-tour">
...
<Card title="Community" icon="users" href="/community/community">
  Connect with other merchants and developers.
</Card>

</CardGroup>

<Note>
  **Questions?** Check our [FAQ](/resources/faq) or explore more [development guides](/development-guide).
</Note>
