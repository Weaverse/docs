...
- **Shopify CLI** installed ([install guide](https://shopify.dev/docs/api/shopify-cli))
...
- Add any other required environment variables (see [Environment Variables](/development-guide/environment-setup)).
...
_Additional Note_: For Shopify Starter or Development plans, use Vercel or another platform, as the Hydrogen app cannot deploy to Oxygen.

## Custom Domain

After deploying to Oxygen, connect your own domain to the Hydrogen storefront. See the **[Custom Domain & DNS Setup](/guides/deployment/custom-domain-and-dns)** guide for detailed instructions.
...
- **Follow Shopify’s security guidelines**: [Hydrogen Content Security Policy](https://shopify.dev/docs/storefronts/headless/hydrogen/content-security-policy)
...
- [Environment Variables](/development-guide/environment-setup)
