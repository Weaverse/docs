...
## Hydrogen Integrations

Connect your Weaverse Hydrogen theme with third-party commerce and marketing services.

<CardGroup cols={2}>
  <Card title="Contact Form with Klaviyo" icon="envelope" href="/hydrogen-integrations/contact-form-klaviyo">
    Build a theme-native contact form with hCaptcha protection and Klaviyo transactional email delivery.
  </Card>
  <Card title="Judge.me Reviews for Hydrogen" icon="star" href="/hydrogen-integrations/judgeme-reviews">
    Add product ratings, review widgets, pagination, and optional review submissions to a Hydrogen storefront.
  </Card>
  <Card title="Shopify Inbox for Hydrogen" icon="messages" href="/hydrogen-integrations/shopify-inbox">
    Add Shopify's online-store chat launcher with safe loading, CSP configuration, and SPA verification.
  </Card>
  <Card title="HubSpot Forms for Hydrogen" icon="address-card" href="/hydrogen-integrations/hubspot-forms">
    Submit contact and lead forms through a validated Hydrogen server route with consent and abuse protection.
  </Card>
  <Card title="Yotpo Reviews for Hydrogen" icon="stars" href="/hydrogen-integrations/yotpo-reviews">
    Add rating and review widgets with correct product IDs, CSP, and SPA reinitialization.
  </Card>
  <Card title="Trustpilot Reviews for Hydrogen" icon="star-half-stroke" href="/hydrogen-integrations/trustpilot-reviews">
    Add product-review widgets and cached server summaries with consistent Shopify SKU mapping.
  </Card>
  <Card title="Instagram Feed for Hydrogen" icon="instagram" href="/hydrogen-integrations/instagram-feed">
    Fetch images, videos, and carousels securely with short caching and long-lived token rotation.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Deployment Overview" icon="cloud" href="/guides/deployment">
    Choose the right deployment strategy for your project.
  </Card>
  <Card title="Shopify Oxygen" icon="server" href="/guides/deployment/oxygen">
    Deploy to Shopify's native hosting platform.
  </Card>
  <Card title="Docker" icon="box" href="/guides/deployment/docker">
    Containerized deployment for custom infrastructure.
  </Card>
  <Card title="Cloudflare Workers" icon="cloud-arrow-up" href="/guides/deployment/workers">
