...
const res = await fetch("https://a.klaviyo.com/api/events", {
  ...
  headers: {
    ...
    Authorization: ["Klaviyo-API-Key", apiToken].join(" "),
  },
...
- Klaviyo: [API overview and authentication](https://developers.klaviyo.com/en/reference/api_overview)
...
- Shopify: [Hydrogen environments and variables](https://shopify.dev/docs/storefronts/headless/hydrogen/environments)
