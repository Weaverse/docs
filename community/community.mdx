...
### GitHub Issues
Report bugs and track fixes in the [Weaverse monorepo issues](https://github.com/Weaverse/weaverse/issues), or in the repository of the theme you're using (for example [Pilot](https://github.com/Weaverse/pilot/issues)).
...
- [Component Development](/development-guide/weaverse-component)
...
- [Weaverse CLI](https://github.com/Weaverse/weaverse/tree/main/packages/cli) - Command-line tool for scaffolding Weaverse Hydrogen projects
