...
description: "A complete guide to setting up, customizing, and deploying a Shopify Hydrogen storefront with Weaverse."
published: true
---
...
3. **Set up environment variables**:
   ...
   # Required - generated automatically by Weaverse CLI/agent setup
...
![Change or manage preview control in Weaverse Studio](/images/tutorial/change-or-manage-preview.png)

![Manage previews dialog with local development URL](/images/tutorial/manage-previews-dialog.png)
...
1. **Create a product loader**:
   ...
   export async function loader(args: ComponentLoaderArgs<HeroBannerProps>) {
     ...
     // A `product` input stores a resource reference, not a bare string —
     // read the handle off it before querying the Storefront API.
...
2. **Update component to use product data**:
   ```typescript
   import type { WeaverseProduct } from '@weaverse/hydrogen';
   ...
   function HeroBanner(props: HeroBannerProps) {
     const { loaderData, product: _product, ...rest } = props;
...
- **[Component Development Guide](/development-guide/weaverse-component)** - Deep dive into component creation
- **[Schema Reference](/development-guide/component-schema)** - Complete schema options
- **[Styling & Theming](/development-guide/styling-theming)** - Performance optimization and design patterns
