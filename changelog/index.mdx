...
### Weaverse Studio
*Vite 8 upgrade, RPC performance improvements, and bug fixes*
...
- **Dependency Upgrades**: Bumped Bun to 1.3.11 and updated project dependencies
...
### Weaverse Studio
*Ghost section detection, auth guards, and multi-store session isolation*
...
- **Dependency Upgrades**: 48 packages upgraded with Biome 2.4.9 compatibility fixes
